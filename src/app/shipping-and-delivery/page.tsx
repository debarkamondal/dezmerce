  ...
  return (
    <>
      ...
      <p>
        ...
        and delivered through registered international courier companies and/or
        ...
        Courier Company / post office norms. Debarka Mondal is not liable for
        ...
        postal authorities within 0-7 days rom the date of the order and payment
        ...
        contact our helpdesk on debarkamondal@gmail.com
      </p>
    </>
  );
};
