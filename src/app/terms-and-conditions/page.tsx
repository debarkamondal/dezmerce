const TermsAndConditionsPage = () => {
  return (
    <>
      <h1 className="my-8 text-4xl font-semibold">Terms and Conditions</h1>
      <p>
        This is a website to add to my portfolio. There are no Terms &
        Condidions. This website is for demonstration purposes (demonstration of
        my skills as a devloeper) please don&apos;t make any payments using your
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Debarka Mondal.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Debarka Mondal, accessible from{" "}
            <a
      ...
      <ul>
        <li>By email: debarkamondal@gmail.com</li>
      </ul>
    </>
  );
};
